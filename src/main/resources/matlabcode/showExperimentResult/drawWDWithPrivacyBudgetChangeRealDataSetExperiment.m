function y = drawWDWithPrivacyBudgetChangeRealDataSetExperiment(filename, xLabelName, yLabelName,outputFileName, figure_MarkerSize, figure_FontSize, figure_FontSize_X, figure_FontSize_Y)
...
y_A_SubGeoI = matrix.data(21:25,wassersteinDistanceIndexLine);

y_B_RAM = matrix.data(26:30,wassersteinDistanceIndexLine);
y_B_DAM = matrix.data(31:35,wassersteinDistanceIndexLine);
y_B_MDSW = matrix.data(36:40,wassersteinDistanceIndexLine);
y_B_HUE = matrix.data(41:45,wassersteinDistanceIndexLine);
y_B_SubGeoI = matrix.data(46:50,wassersteinDistanceIndexLine);


y_C_RAM = matrix.data(51:55,wassersteinDistanceIndexLine);
y_C_DAM = matrix.data(56:60,wassersteinDistanceIndexLine);
y_C_MDSW = matrix.data(61:65,wassersteinDistanceIndexLine);
y_C_HUE = matrix.data(66:70,wassersteinDistanceIndexLine);
y_C_SubGeoI = matrix.data(71:75,wassersteinDistanceIndexLine);
