function y = drawWDWithContributeKChangeSyntheticDataSetExperiment(filename, xLabelName, yLabelName,outputFileName, figure_MarkerSize, figure_FontSize, figure_FontSize_X, figure_FontSize_Y)
