function y = drawWDWithPrivacyBudgetChangeSyntheticDataSetExperiment(filename, xLabelName, yLabelName_left, yLabelName_right,outputFileName, figure_MarkerSize, figure_FontSize, figure_FontSize_X, figure_FontSize_Y)
...
y_MDSW = matrix.data(6:10,wassersteinDistanceIndexLine_2);
y_HUE = matrix.data(11:15,wassersteinDistanceIndexLine_2);
y_DAMShrink = matrix.data(16:20,wassersteinDistanceIndexLine_2);
y_SubGeoI_2 = matrix.data(21:25,wassersteinDistanceIndexLine_2);
