function y = extended_drawWDWithPBChangeSyntheticDataSetExperiment(filename, xLabelName, yLabelName_left, outputFileName, figure_MarkerSize, figure_FontSize, figure_FontSize_X, figure_FontSize_Y)
