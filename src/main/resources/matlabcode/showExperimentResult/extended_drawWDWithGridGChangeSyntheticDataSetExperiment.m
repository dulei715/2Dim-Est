function y = extended_drawWDWithGridGChangeSyntheticDataSetExperiment(filename, xLabelName, yLabelName_left, yLabelName_right,outputFileName, figure_MarkerSize, figure_FontSize, figure_FontSize_X, figure_FontSize_Y)
...
y_SubGeoI_2 = matrix.data(6:10,wassersteinDistanceIndexLine_2);
