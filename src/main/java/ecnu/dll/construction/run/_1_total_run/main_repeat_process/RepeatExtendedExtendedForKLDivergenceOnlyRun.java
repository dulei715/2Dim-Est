...
import ecnu.dll.construction.run._1_total_run.main_process.d_total_run.TotalRunExtendedExtendedForKLDivergenceOnly;

import java.util.List;
import java.util.Map;

@SuppressWarnings("Duplicates")
public class RepeatExtendedExtendedForKLDivergenceOnlyRun {
...
//            normalOutputDir = Constant.outputNormalDir;
            ...
            Map<String, Map<String, Map<String, List<ExperimentResult>>>> resultMap = TotalRunExtendedExtendedForKLDivergenceOnly.runAndWrite(crimeDataSetArray, crimeOutputDirArray, nycDataSetArray, nycOutputDirArray, twoDimNormalDataSet, normalOutputDir, twoDimZipfDataSet, zipfOutputDir, twoDimNormalMultiCentersDataSet, normalMultiCentersOutputDir);
