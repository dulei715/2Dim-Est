...
//        String subsetGeoITwoNorm = Constant.subsetGeoITwoNormSchemeKey;
        String ldpTrace = Constant.ldpTraceSchemeKey, pivotTrace = Constant.pivotTraceSchemeKey;
        ...
        for (int i = 0; i < arraySize; i++) {
            ...
            // for ldpTrace
            tempLDPTraceExperimentResult = LDPTraceRun.run(integerPointList, rawDataStatistic, gridLength, inputSideLength, transformedEpsilon, xBound, yBound);
            subsetGeoITwoNormExperimentResultList.add(tempLDPTraceExperimentResult);
