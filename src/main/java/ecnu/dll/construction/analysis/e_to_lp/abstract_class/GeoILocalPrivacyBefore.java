...
@Deprecated
public abstract class GeoILocalPrivacyBefore extends TransformLocalPrivacy<TwoDimensionalIntegerPoint, Integer> {
...
//    protected Integer sizeD = null;
    ...
    @Deprecated
    public GeoILocalPrivacyBefore(List<TwoDimensionalIntegerPoint> originalSetList, Integer setSizeK, Double[] massArray, Double epsilon, Double omega, DistanceTor<TwoDimensionalIntegerPoint> distanceTor) {
    ...
    public GeoILocalPrivacyBefore(DiscretizedSubsetExponentialGeoI geoIScheme, DistanceTor<TwoDimensionalIntegerPoint> distanceCalculator) {
        super(null, null);
