...
public class Norm2RAMLocalPrivacy extends RAMLocalPrivacy {
    ...
    public Norm2RAMLocalPrivacy(List<IdentityPair<Integer>> originalSetList, List<IdentityPair<Integer>> intermediateSetList, Integer sizeB, Double probabilityP, Double probabilityQ) {
